...
void solve(){
    ...
    for(auto it:v){
        ...
        ll X_val=c-it+1;
        subtractionCnt+=(X_val);
    }
    commonCnt+=(((even)*(even+1))/2+((odd)*(odd+1))/2);
    // cout<<totalCnt<<"\n"<<sumCnt<<" "<<subtractionCnt<<" "<<commonCnt<<"\n";
    cout<<totalCnt-sumCnt-subtractionCnt+commonCnt<<"\n";
